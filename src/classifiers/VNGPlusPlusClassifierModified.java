...
// same as SetwiseClassifier.java but NaiveBayse
public class VNGPlusPlusClassifierModified {
...
//				System.out.println("value to be updated: " + Integer.getInteger(instance.get(dataKey)) + 1));
	...
	{
		// This method is to be used for setwise classification, Nov 03, 2014
